  ...
  if (effectiveStake) {
    return (
      <div className="boosting-info-content">
        ...
        <p>
          User has now effective stake of 12.5 ZZZ staked, that means a bonus of
          2.5 ZZZ is added to the staking amount
        </p>
        <p>
          <b>EXAMPLE2: User stakes 100ZZZ and buys a 40% boost.</b>
        </p>
        <p>
          User has now effective stake of 140 ZZZ staked, that means a bonus of
          40 ZZZ is added to the staking amount
        </p>
        <p>
          <b>NOTE:</b>
          <br />
          <br />
          This has an effect on users who do not have a boost since there is
          more effective balance on the pool. <br />
          <br />
          That means a non-boosted user will have a effective balance LESS than
          the users who have bought boosts, meaning that their rewards are
          reduced while boosted users gain more share of the total staked
          amount.
          <br />
          <br />
          Also the pools with an effective staking bonus will have a reward
          taxation of 4% sent to the treasury.
        </p>
      </div>
    );
  }
  return (
    <div className="boosting-info-content">
      ...
      <p>
        ...
        Bonuses do not apply across multiple addresses.{" "}
      </p>
      <p style={{ marginBottom: "30px" }}>
        <b>
          ...
          <br />
          3. Total amount of ZZZ redeemable from your ETH / ZZZ UNI Liquidity
          Tokens on Uniswap.
        </b>
      </p>
      <p>
        As a thank you for contributing to the ETH/ZZZ UNISWAP Liquidity Pool:{" "}
        <br />
        <br />
        The ZZZs wrapped in UNISWAP ZZZ / ETH LP tokens themselves will count as
        double <br />
      ...
      <p>
        <h3>NOTE</h3>
        Staked UNI Liquidity Tokens <b>DO NOT</b> count towards your boost
        level.
      </p>
      <h2>Examples</h2>
      <p>
      ...
      <p className="important-paragraph">
        <b>
          <i>
            Unclaimed rewards from any pools will not count towards your
            multiplier.
          </i>
        </b>
      </p>
      ...
      <p>
        ...
        to get bonuses on individual pools.
      </p>
      <p>
        Depending on the amount you spend it increases your bonus. This effect
        works exclusively on the pools you choose.
      </p>
      <p>
        {" "}
        It will <b>NOT</b> be transferred from a version 1 pool to a version 2
        eventhough the pools might share the same name.
      </p>
      <p>* Example 1</p>
      <p>
      ...
      <p>
        The cost of the multipliers drop by 10% every X hours according to pool
        duration. This will occur 5 times, and then hold steady.
      </p>
      <p>Examples:</p>
      <p>

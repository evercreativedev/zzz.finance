  ...
  },
  {
    ...
    extra: () => (
      <span className="extra-text">
        Head over to pools to see them out. They include a global boost for your total ZZZ staked in the vault. (this includes underlying
        tokens in both ZZZ/ETH and ZZZ/NAP)
      </span>
    ),
    link: "/#/pools",
  },
